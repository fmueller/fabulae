...
def register_shapes_commands(app: typer.Typer) -> None:
    ...
    @app.command(name="shapes", help="List all available story shapes.")
    def shapes_command() -> None:
    ...
    @app.command(name="shape", help="Show details of a specific story shape.")
    def shape_command(shape_id: Annotated[str, typer.Argument(help="Story shape ID to display.")]) -> None:
